(function ($) {
	...
	self.actions = (function (){
		...
		var doMove = function (){
				...
				var activeIndex = self.state.activeIndex,
					$covers = $(".testimonial-content"),
					newActive,oldActive = $(".testimonial-content .t-active");
				
				$covers.each(function (i, e){
					
					if( i < activeIndex ){
						
						this.className = "testimonial-content inactiveLeft inactiveLeft" + (activeIndex - i) ;
						
					}
					else if( i === activeIndex ){
						this.className = "testimonial-content t-active";
						newActive = this;
					}
					else if( i > activeIndex ){
					
						this.className = "testimonial-content inactiveRight inactiveRight" + ((activeIndex - i)*-1) ;
	...
	self.imgs = (function (){
		...
		var attachEvents = function (){
			...
			$(".testimonial-content").on("click",function (event){
				...
				var dir = this.className.search(/left/gi) !==-1 ? "Right" : "Left",
                    $coll = $(".testimonial-content"),
					diff = dir === "Right" ? ($coll.index($(".testimonial-content.t-active")) - $coll.index(this)) :
							($coll.index($(".testimonial-content.t-active")) - $coll.index(this)) * -1,
					x;
		...
		var attachEvents = function (){
			...
			$(".cbcontrol").on("click", function (event){
				...
				var dir = self.utils.getDir(this.id),
					active = $(".testimonial-content.t-active"),
					makeActive = dir === "Right" ? active.prev(".testimonial-content") : active.next(".testimonial-content");
	...
	self.init = (function (){
        ...
        var $covers = $(".testimonial-content"),
            ...
            generateClasses = function(){
                ...
                ss.insertRule(".stage .t-active{left:"+al+"px;}",0);
            ...
            doInit = function(){
                ...
                var $active = $covers.filter(".t-active"),
